...
inherit vim-doc flag-o-matic fdo-mime bash-completion-r1 python-single-r1 \
		lua-single ruby-single toolchain-funcs desktop xdg-utils autotools

DESCRIPTION="Vim, an improved vi-style text editor"
HOMEPAGE="http://www.vim.org/ https://github.com/vim/vim"
SRC_URI="https://github.com/vim/vim/archive/v9.2.0315/v9.2.0315.tar.gz -> vim-9.2.0315.tar.gz"
