...
SRC_URI="https://vscode.download.prss.microsoft.com/dbazure/download/stable/5264f2156cbcd7aea5fd004d29eaa10209155d66/code-stable-x64-1784039387.tar.gz -> vscode-bin-1.128.1.tar.gz"
...
src_install() {
	...
	fperms +x "${MY_INSTALL_DIR}/resources/app/node_modules/@github/copilot-linux-x64/prebuilds/linux-x64/runtime.node"
	fperms +x "${MY_INSTALL_DIR}/resources/app/node_modules/@github/copilot-linux-x64/ripgrep/bin/linux-x64/rg"
	...
	fperms +x "${MY_INSTALL_DIR}/resources/app/node_modules/@vscode/ripgrep-universal/bin/linux-x64/rg"
	...
	fperms +x "${MY_INSTALL_DIR}/resources/app/node_modules/playwright-core/bin/reinstall_chrome_beta_linux.sh"
	fperms +x "${MY_INSTALL_DIR}/resources/app/node_modules/playwright-core/bin/reinstall_chrome_beta_mac.sh"
	fperms +x "${MY_INSTALL_DIR}/resources/app/node_modules/playwright-core/bin/reinstall_chrome_stable_linux.sh"
	fperms +x "${MY_INSTALL_DIR}/resources/app/node_modules/playwright-core/bin/reinstall_chrome_stable_mac.sh"
	fperms +x "${MY_INSTALL_DIR}/resources/app/node_modules/playwright-core/bin/reinstall_msedge_beta_linux.sh"
	fperms +x "${MY_INSTALL_DIR}/resources/app/node_modules/playwright-core/bin/reinstall_msedge_beta_mac.sh"
	fperms +x "${MY_INSTALL_DIR}/resources/app/node_modules/playwright-core/bin/reinstall_msedge_dev_linux.sh"
	fperms +x "${MY_INSTALL_DIR}/resources/app/node_modules/playwright-core/bin/reinstall_msedge_dev_mac.sh"
	fperms +x "${MY_INSTALL_DIR}/resources/app/node_modules/playwright-core/bin/reinstall_msedge_stable_linux.sh"
	fperms +x "${MY_INSTALL_DIR}/resources/app/node_modules/playwright-core/bin/reinstall_msedge_stable_mac.sh"
